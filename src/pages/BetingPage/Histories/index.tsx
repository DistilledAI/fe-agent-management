...
export const MOCK_HISTORIES = [
  {
    ...
    reward: 3405,
    result: BET_TYPE.UP,
    user: "AibbRmmmDPSK7TbJsUbQzoXnJmTrnpZV4U3WW5feZfhg",
    eventAddr: "29zcjQU42xPCP6zea89R3tBWPSsPPW3tyGe77FaMQ1zG",
    orderAddr: "EgDrNUgqfB76dVE8aPe5CZkPtgXMH2NtVj1y7Gfrheg9",
    amount: "99000000",
    outcome: "Up",
    isClaimed: false,
    claimAmount: "0",
    createTx:
      "63AQtKaEz9qJ1GDuXCTBL21m5xivoUxX7rZqs9Nmthou4bjUXEfvQVLjr39nP6DpdJ3a6ZyRY7Y4HV1keRY3bB2Q",
    claimTx: "",
  },
  {
    round: 121,
