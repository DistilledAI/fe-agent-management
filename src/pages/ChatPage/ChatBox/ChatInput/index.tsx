...
const ChatInput: React.FC<{ isDisabledInput: boolean }> = ({
  ...
  return (
    <div
      ref={boxRef}
      className={twMerge(
        "max-sm:static max-sm:gap-2 absolute -bottom-[79px] left-0 z-[11] flex w-full items-center gap-4 rounded-[35px] border-1 bg-mercury-200 p-2 py-1 duration-500 sm:p-3 sm:py-[7.89px]",
