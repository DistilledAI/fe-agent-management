...
const ChatInput: React.FC<{ isDisabledInput: boolean }> = ({
  ...
  return (
    <div
      ref={boxRef}
      className={twMerge(
        "absolute bottom-0 left-0 z-[11] flex w-full items-center gap-4 rounded-[35px] border-1 bg-mercury-200 p-2 py-1 duration-500 max-sm:static max-sm:gap-2 sm:p-3 sm:py-[7.89px]",
